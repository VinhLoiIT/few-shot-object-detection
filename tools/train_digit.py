...
register_coco_instances("digits_train", {}, "json_annotation_train.json", "path/to/image/dir")
register_coco_instances("digits_val", {}, "json_annotation_val.json", "path/to/image/dir")
